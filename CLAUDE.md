...
- **ข้อ 1 "อ" = กลุ่ม 6 ✅** (ระบบถูกแล้ว — ธง §4 ข้อ 6 ปิดสมบูรณ์) · **ข้อ 2 ส = กลุ่ม 7 ตามตาราง ✅**
  (ตัวอย่าง "สมชาย" ในตำราพิมพ์ผิด — โค้ดเราถูกอยู่แล้ว) ⚠️ **ประเด็นนับสระ/วรรณยุกต์ยังไม่ได้คำตอบ**
  — ตารางภาคผนวกให้ค่าสระ แต่โค้ด (namePower) นับเฉพาะพยัญชนะ+อังกฤษ · **ห้ามแก้เองเด็ดขาด**:
  เปลี่ยนแล้วการ์ดผู้ใช้เดิมเปลี่ยนทั้งระบบ (§4.1) ต้องถามเจ้าของตำราซ้ำ+ผู้ใช้ตัดสิน
