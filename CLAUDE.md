...
- 🔴 `lucky_number` ("เด่น 08-80 · วิ่ง 0 8") — **เก็บลงข้อมูลแต่จงใจไม่แสดงให้ผู้ใช้เห็น** เพราะเป็น
  ภาษาใบ้หวยตรงๆ ซึ่งขัดกับ guardrail ที่ปฏิเสธคำถามหวยอยู่แล้ว (ดักไม่ให้ถามแต่ยื่นเลขให้เอง = ขัดกันเอง)
  **ต้องให้ผู้ใช้ตัดสินก่อนเปิดใช้** · มีเทสต์/ตรวจ HTML ยืนยันว่าไม่หลุดออกหน้าเว็บ
