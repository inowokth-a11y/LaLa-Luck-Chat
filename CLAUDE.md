...
- ลัคนาเทียบดวงจริง 2-3 ดวง (**รอดวงจากผู้ใช้** — §5.2)
- สุ่มตรวจ figure_bio โดยเฉพาะ mythological/legendary 24 รายการ (§3.7)
- คำถามถึงเจ้าของตำรา/ทีม D: ตัวอักษร "อ" กลุ่ม 4 หรือ 6 · สูตรเบอร์โทรจริง (Logic 2) ·
  ตาราง 9 กลุ่มอักษร→ธาตุ (Logic 19) · นิยาม `users.thai_element` ของ D
