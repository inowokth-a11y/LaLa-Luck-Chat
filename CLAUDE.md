...
| โค้ด | **retention ความจำแม่หมอ** — ใส่ข้อความใน /privacy + งานลบตามอายุ ⚠️ ต้องให้ผู้ใช้ตัดสินระยะเก็บก่อน (เสนอ 12 เดือน) |
...
| โค้ด | **อัตราคอมมิชชันแอฟฟิลิเอต + บันทึกการจ่าย** ⚠️ ต้องให้ผู้ใช้ตัดสินอัตรา (% ของรายรับ) ก่อน |
...
**การตัดสินใจที่ค้างกับผู้ใช้ (ถามก่อนเริ่มงานที่เกี่ยว):** ① ระยะเก็บความจำแม่หมอ (เสนอ 12 เดือน)
② อัตราคอมมิชชันแอฟฟิลิเอต ③ จะเปิดช่องทาง LINE OA เลยไหมหรือเว็บอย่างเดียวก่อน
