...
3. ⬜ **รอบ 3 /compatibility (บุคคล): Ashtakoota/พอรุตธรรม** — คะแนนคู่ 36 จากนักษัตรสองฝ่าย ·
   วิจัย: ตาราง 8 กูฏ · ใช้กับ entity ประเภทบุคคล+โหมด match เนื้อคู่
...
cd /Users/freeman/Desktop/kruth-element
npx tsc --noEmit && npm test && npm run build   # ควรได้ 525/525 (24 ส.ค. 2569)
```
