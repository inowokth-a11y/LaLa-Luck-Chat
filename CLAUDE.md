...
- ⚠️ **ตารางทางการไม่มีค่า ี ึ ื ะ ็ ๊ ๋ + สระเอือประสม** → ข้าม (=0) ไม่เดา — คำถามรอบสอง 3 ข้อ
  อยู่ท้าย docs/คำถามถึงเจ้าของตำรา แล้ว (รวมขอยืนยันกฎ "อ")
- 🔴 **การ์ดสูตร A เปลี่ยนใบสำหรับชื่อที่มีสระ** (ผู้ใช้รับทราบ — ช่วงเปิดตัวผู้ใช้น้อย เปลี่ยนตอนนี้
  ...
  (digitSum/reduceTo99 ยังเทียบ prototype) · ผลพวง: สมชาย เลขศาสตร์ 22→23 · องค์ประกอบธาตุ
