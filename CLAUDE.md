...
- ⬜ ประเมินให้ผู้ใช้แล้ว (รอเคาะ): โหมด "เช็คกับคนที่สนใจ" — วันเกิด✅/เวลาเกิด✅/ชื่อ⚠️(ตารางรอยืนยัน)/
  **รูปถ่ายบุคคลที่สาม❌** (ชีวมิติคนอื่นให้ consent แทนไม่ได้ + Logic 5/6 ยังไม่มีสูตร)
