...
2. ⬜ **รอบ 2 /fortune + first-reading: ยุคชีวิต Vimshottari** — มหา/อันตรทศาปัจจุบัน + convergence
   กับปีส่วนบุคคล · วิจัย: กฎตีความมหาทศารายดาวแบบทั่วไป
...
cd /Users/freeman/Desktop/kruth-element
npx tsc --noEmit && npm test && npm run build   # ควรได้ 516/516 (24 ส.ค. 2569)
```
