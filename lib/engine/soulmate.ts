...
export const SOULMATE_SCOPE_NOTE =
  "หัวข้อ พื้นเพครอบครัว · ฐานะ · อายุ ยังไม่เปิดในเวอร์ชันนี้ เพราะตำราต้นทางยังไม่มีข้อมูลรองรับ " +
  "(อยู่ระหว่างสอบถามเจ้าของตำรา) — ส่วน 'บริบทที่มักพบคู่' และ 'จังหวะเวลาเรื่องคู่' " +
  "เปิดให้ผ่านชั้น Jyotish สากลซึ่งเป็นชั้นเสริม (มี caveat กำกับแยก)";
