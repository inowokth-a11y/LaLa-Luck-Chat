...
export const NAME_TABLE_CAVEAT =
  "ธาตุจากชื่อใช้เกณฑ์ เลขกลุ่มอักษร→ดาวประจำเลข→ธาตุประจำวันตามตำรา (ราหู=ดิน เกตุ=ไฟ อนุมานผ่านดาวแม่แบบ) — เป็นชั้นเสริมประกอบ รอเจ้าของตำรายืนยันขั้นสุดท้าย";
