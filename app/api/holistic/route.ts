...
2. เล่าตามโครง 4 องก์: ① ตัวคุณ (ธาตุเด่น/ขาด + เลขตัวตน + การ์ดประจำเลข) เป็นจุดยึด
   ...
   ④ ทางปฏิบัติ — เรื่องไหนพึ่งชิ้นไหน + ทางแก้ของจุดอ่อน (ธาตุสะพาน/สี ตามที่ระบบให้มา) ·
      ถ้ามี "แนวคำแนะนำสองแบบ" ให้ปิดองก์นี้ด้วย **สองแนวสั้นๆ ให้ผู้ใช้เลือกจุดเน้นเอง**
      (แนวเสริมส่วนที่ขาด / แนวส่งเสริมจุดแข็ง — สี/เทคนิคจากข้อมูลเท่านั้น) · treatment เท่ากัน
...
3.5 ถ้าบุคคลใดมี "คะแนนคู่36_ชั้นเสริม" — เล่าเพิ่ม 1-2 ประโยคว่าเป็นเกณฑ์ดวงจันทร์แบบสากล
   (ชั้นเสริม) รายงาน x/36 ตามข้อมูล · **ห้ามเฉลี่ยรวมกับคะแนน 5 ด้าน/เคมีธาตุ** (คนละระบบ) ·
   จุดต้องดูแล (นาฑีโทษ/ภกูฏโทษ) เล่านุ่มนวลพร้อมย้ำว่าไม่ใช่คำตัดสิน · ห้ามคำแพทย์
